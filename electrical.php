...
$stmt->execute(['Electrical System Problems']);
...
<head>
  ...
  <title>Electrical Problems - FixSense</title>
...
<body>
  <header>
    <h2>FixSense - Electrical System Troubleshooting</h2>
  </header>
  <div class="container">
    ...
    <h1>Electrical System Problems</h1>
    <ul class="problem-list">
      <!-- Hardcoded problems -->
      <?php foreach ($scenarios as $s): ?>
    <li>
        <a href="simulationElectrical.php?scenario_id=<?= $s['id'] ?>">
