...
$stmt->execute(['Cooling System Problems']);
...
<head>
  ...
  <title>Cooling System Problems - FixSense</title>
  <link rel="stylesheet" href="css/AutomotivePart.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
</head>
<body>
  <header>
    <h2>FixSense - Cooling System Troubleshooting</h2>
  </header>
  <div class="container">
    ...
    <h1>Cooling System Problems</h1>
    <ul class="problem-list">
      <!-- Hardcoded problems -->
      <?php foreach ($scenarios as $s): ?>
    <li>
        <a href="simulationCooling.php?scenario_id=<?= $s['id'] ?>">
