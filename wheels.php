...
$stmt->execute(['Wheels System Problems']);
...
<head>
  ...
  <title>Wheels System Problems - FixSense</title>
  <link rel="stylesheet" href="css/AutomotivePart.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
</head>
<body>
  <header>
    <h2>FixSense - Wheels System Troubleshooting</h2>
  </header>
  <div class="container">
