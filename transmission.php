...
// Ambil semua scenario kategori Transmission System dari database
$stmt = $pdo->prepare("SELECT * FROM scenarios WHERE category = ? ORDER BY id DESC");
$stmt->execute(['Transmission System Problems']);
...
<head>
  ...
  <title>Transmission Problems - FixSense</title>
  ...
  <div class="container">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
      ...
      <div style="display: flex; gap: 10px;">
        ...
        <a href="transmission_tools.php" class="tools-button">
          <i class="fas fa-wrench"></i> Transmission Tools
        </a>
      </div>
    </div>
    <h1>Transmission System Problems</h1>
    <ul class="problem-list">
      <!-- Hardcoded problems -->
      <?php foreach ($scenarios as $s): ?>
    <li>
        <a href="simulationTransmission.php?scenario_id=<?= $s['id'] ?>">
